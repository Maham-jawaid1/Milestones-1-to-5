...
let baseurl = "file:///E:/Hackathon/Milestone%205/public/Milestone%201%20and%202/resume.html";
...
copy_btn?.addEventListener("click", () => (navigator.clipboard.writeText(uniqueurl).then(() => {
    alert("Copy Succesfull");
})));
